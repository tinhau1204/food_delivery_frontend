...
export async function getAllProductsType(data) {
  return await AxiosCLient.fetchingWithData("get", "/menu/get-all-product-type/" + data);
}

export async function getProductType(data) {
  return await AxiosCLient.fetchingWithData("get", "/menu/get-product-type/" + data);
}

export async function editProductType(data) {
  return await AxiosCLient.fetchingWithData("post", "/menu/edit-product-type", data);
}
...
export async function createProductType(data) {
  return await AxiosCLient.fetchingWithData("post", "/menu/new-product-type", data);
}
...
export async function getRandomProducts(data) {
  return await AxiosCLient.fetchingWithData("post", "/menu/random-products", data);
}
